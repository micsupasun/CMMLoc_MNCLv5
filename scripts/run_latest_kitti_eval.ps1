...
$basePath = Join-Path $RepoRoot "data\k360_30-10_scG_pd10_pc4_spY_all"
...
$evalSplit = if ($Split -eq "test") { "kitti360_test" } else { "kitti360_val" }
