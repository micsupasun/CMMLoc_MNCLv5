...
$dataset = Join-Path $RepoRoot "data\k360_30-10_scG_pd10_pc4_spY_all"
$root = Join-Path $RepoRoot "checkpoints\k360_30-10_scG_pd10_pc4_spY_all"
$pointnet = Join-Path $RepoRoot "checkpoints\pointnet_acc0.86_lr1_p256.pth"

$cmmlocCoarse = Join-Path $root "cmmlocpp_mncl_v2\coarse.pth"
$mnclCoarse = Join-Path $root "cmmlocpp_mncl_v2\coarse_contN_epoch15_acc0.624_ecl0_eco0_p256_npa1_loss-contrastive_f-class-color-position-num.pth"
$rerankCoarse = Join-Path $root "cmmlocpp_mncl_rerank_v1\coarse_contN_epoch3_acc0.796_ecl0_eco0_p256_npa1_loss-contrastive_f-class-color-position-num.pth"
$fine = Join-Path $root "cmmlocpp_mncl_v2_fine\fine_contN_epoch41_offset0.103_lr0.0003_obj-6-16_ecl0_eco0_p256_npa1_f-class-color-position-num.pth"
